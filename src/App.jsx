...
// ---------------------------------------------
function ParallaxBand({ src, children, first = false, zoom = 1.5, speed = 1 }) {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      // Progress 0 → 1 as the band travels through viewport
      const total = vh + rect.height;
      const raw = (vh - rect.top) / total;
      const progress = Math.min(1, Math.max(0, raw));

      // Speed as an easing exponent:
      //  - speed < 1  = stays zoomed longer
      //  - speed = 1  = linear (current behavior)
...
export default function App() {
  ...
  return (
    <div className="page">
      ...
      <ParallaxBand src="/images/cowboy-1.jpeg" first zoom={1.5} speed={1}>
      ...
      <ParallaxBand src="/images/cowboy-2.jpeg" zoom={1.5} speed={1}>
      ...
      <ParallaxBand src="/images/cowboy-3.jpeg" zoom={1.8} speed={1}>
