...
// ---------------------------------------------
// PhotoSection = one background image section
// ---------------------------------------------
function PhotoSection({ id, bg, children }) {
  return (
    <section
      id={id}
      className="photo-section full-bleed"
      style={{ backgroundImage: `url(${bg})` }}
    >
      <div className="photo-section-inner">{children}</div>
    </section>
  );
}
...
export default function App() {
  ...
  return (
    <div className="page">
      ...
      {/* PHOTO SECTION 1 – ABOUT / FORMAT */}
      <PhotoSection id="about" bg="/images/cowboy-1.jpeg">
      ...
      {/* PHOTO SECTION 2 – PLAYER LEADERBOARD (GATED) */}
      <PhotoSection id="players" bg="/images/cowboy-2.jpeg">
        <div className="section-header">
      ...
      {/* PHOTO SECTION 3 – HORSES & REMUDA (GATED) */}
      <PhotoSection id="horses" bg="/images/cowboy-3.jpeg">
        <div className="section-header">
