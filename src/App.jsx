...
export default function App() {
  ...
  return (
    <div className="page">
      ...
      {/* -----------------------------------------
         BACKGROUND PHOTO 1: ABOUT / FORMAT
         ----------------------------------------- */}
      <section id="about" className="bg-photo bg-photo-1 full-bleed">
      ...
      {/* -----------------------------------------
         BACKGROUND PHOTO 2: PLAYER LEADERBOARD
         ----------------------------------------- */}
      <section id="players" className="bg-photo bg-photo-2 full-bleed">
        <div className="band-inner">
          <div className="section-header">
      ...
      {/* -----------------------------------------
         BACKGROUND PHOTO 3: HORSES / REMUDA
         ----------------------------------------- */}
      <section id="horses" className="bg-photo bg-photo-3 full-bleed">
        <div className="band-inner">
          <div className="section-header">
      ...
      {/* RESULTS / NETLIFY FORM (plain black background) */}
      <section id="results" className="bg-solid full-bleed">
        <div className="band-inner">
          <div className="section-header">
            ...
            <div aria-hidden={!isConnected && true}>
              <div className="section-body">
                ...
                <p>
                  ...
                  season’s record can be prepared for on-chain archival inside
                  the Patronium ecosystem.
                </p>
              </div>
          ...
          <footer>
            © <span>{year}</span> UNITED STATES POLO PATRONS ASSOCIATION ·
            COWBOY POLO CIRCUIT
          </footer>
        </div>
      </section>
